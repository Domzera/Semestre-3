...
public class Lista03Exerc02 {
	...
	public static void main (String[] args) {
		...
		if(a.equals("c") || a.equals("C")){
			System.out.println("A temperatura em Celsius eh: "+conversao(a,b));
		}else{		
		System.out.println("A temperatura em Fahrenheit eh: "+conversao(a,b));
		}
	}
	
	static int conversao (String c,int d){
